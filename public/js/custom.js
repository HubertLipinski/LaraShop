...
$(document).ready(function()
{
	...
	*/
					...
					if(item.hasClass("has-children"))
					{
						item.on('click', function(evt)
						{
						    ...
						    if(subItem.hasClass('active'))
						    {
                                ...
                                const currHeight = subItem.height();
                                subItem.height(currHeight).animate({height: 0}, SUB_MENU_TIME);
						    }
						    else
						    {
						    	subItem.toggleClass('active');
                                const currHeight = subItem.height();
                                const autoHeight = subItem.css('height', 'auto').height();
                                subItem.height(currHeight).animate({height: autoHeight}, SUB_MENU_TIME);
						    }
						});
					}
				});
	...
	function openMenu()
	{
		var menu = $('.page_menu');
		var menuContent = $('.page_menu_content');
		menuContent.css('height', 'auto').height();
		menuActive = true;
	}
	...
	function closeMenu()
	{
		var menu = $('.page_menu');
		var menuContent = $('.page_menu_content');
        const currHeight = menuContent.height();
        menuContent.height(currHeight).animate({height: 0}, MENU_TIME);
		menuActive = false;
	}
